                        ...
                        <#items as vo>
                            ...
                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                ...
                                <#if vo.followed>
                                    ...
                                    <div class="zg-right">
                                        <button class="zg-btn zg-btn-unfollow zm-rich-follow-btn small nth-0 js-follow-user"
                                                data-status="1" data-id="${vo.user.id}">取消关注
                                        </button>
                                    </div>
                                <#else>
                                    <div class="zg-right">
                                        <button class="zg-btn zg-btn-follow zm-rich-follow-btn small nth-0 js-follow-user">
                                            关注
                                        </button>
                                    </div>
                                </#if>
                                ...
                                <div class="zm-list-content-medium">
                                    <h2 class="zm-list-content-title"><a data-tip="p$t$buaabarty"
                                                                         href="/user/${vo.user.id}" class="zg-link"
                                    ...
                                    <div class="details zg-gray">
                                        ...
                                        /
                                        <a target="_blank" href="#" class="zg-link-gray-normal">${vo.commentCount}
                                            回答</a>
                                        /
